...
These factors explain why the exploitable fraction ($\sim$59\%) remains consistent across architectures with 8--128 experts: the \textit{relative} reduction from power-law concentration and cross-layer dependencies is architecture-invariant, even as absolute entropy varies.
