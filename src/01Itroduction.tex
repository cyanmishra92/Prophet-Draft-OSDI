...
\noindent$\bullet$ \textbf{Cross-architecture and cross-domain evaluation:} Comprehensive evaluation across six MoE architectures (Switch Transformer, Mixtral-8x7B, Qwen1.5-MoE, Qwen3-30B, DeepSeek-MoE-16B, GPT-OSS-20B) and six datasets, demonstrating $1.5\times$--$12.7\times$ speedups and robust cross-domain generalization.
