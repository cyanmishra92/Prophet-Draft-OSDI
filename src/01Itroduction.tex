...
\noindent$\bullet$ \textbf{Complete inference system:} An end-to-end system that combines neural prediction with confidence-guided cache placement, achieving $1.5\times$--$10.4\times$ TPOT speedups through proactive expert loading without requiring model modifications.
