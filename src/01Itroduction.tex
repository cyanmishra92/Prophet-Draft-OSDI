...
\vspace{-10pt}
\caption{I/O-to-compute breakdown for MoE inference at batch size 1. Expert transfer (red) dominates execution time across all five evaluation models, consuming 35--92\% of total latency.}
