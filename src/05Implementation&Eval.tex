...
Prophet achieves 80--89\% Top-1 accuracy across all models, with Recall@k exceeding 91\% in all cases. The higher Recall@k values (vs Top-1) indicate that Prophet's probability ranking is well-calibrated: even when the top-1 prediction is incorrect, the true experts typically appear in the top-k predictions. This property is crucial for effective prefetching, where coverage matters more than strict precision.
