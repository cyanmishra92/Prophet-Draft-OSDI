...
\Cref{fig:cross_domain} presents zero-shot cross-domain transfer matrices for all five models. Prediction accuracy remains 67--98\% across all 180 train-test domain pairs, with only 3--8\% degradation vs. in-domain---confirming Prophet learns model-intrinsic routing structure rather than dataset-specific patterns.
